                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block bg-login-image">
                            ...
                            <div class="judul">
                                <center>
                                    <img width="150px" src="<?= base_url() ?>assets/icon/hack.jpg" alt="">
                                </center>
                            </div>
                                <br>
                                <div class="spinner">
                                ...
                                <div class="judul">
                                    ...
                                    <div class="text-center">
                                        <h1 class="h2 text-gray-800 mb-4"><b>CRUD BUKU - Ci3</b></h1>
                                    </div>
                                    <div class="text-center">
                                        <h1 class="h3 text-gray-900 mb-4">RIKO SANJAYA</h1>
                                    </div>
                                    <hr>
                                </div>
